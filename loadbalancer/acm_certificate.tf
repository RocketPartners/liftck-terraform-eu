...
resource "aws_acm_certificate" "tfer--459af342-88df-4c7f-aa12-7a17dad4417c_-002A--002E-circleklift-002E-com" {
  domain_name   = "*.circlekliftdev.com"
  key_algorithm = "RSA_2048"
  ...
  subject_alternative_names = ["*.circlekliftdev.com"]
  validation_method         = "DNS"
}

resource "aws_acm_certificate_validation" "circleklift_com" {
  certificate_arn         = aws_acm_certificate.tfer--459af342-88df-4c7f-aa12-7a17dad4417c_-002A--002E-circleklift-002E-com.arn
  validation_record_fqdns = ["circlekliftdev.com", "_267f10d34097eb6ce762c566ee94e11a.circlekliftdev.com",]
}